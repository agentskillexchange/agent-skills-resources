...
def main() -> int:
    ...
    for section in ["## learning", "## cookbook", "## diagrams", "## ecosystems", "## ops", "## security", "## checklists", "## contributing"]:
